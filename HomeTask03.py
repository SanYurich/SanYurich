...
# mum2 = int(input("Введите второе значение: "))
# print("Наименьший общий множитель =", lcm(numA, mum2))
...
#       numB, " равен ", search_NOK(numA, numB))
...
# decimal = 0.0121111
# str_dec = str(decimal)
# length_dec = abs(str_dec.find('.') - len(str_dec)) - 1
# number_pi = round(math.pi, length_dec)
# print(length_dec, number_pi)
